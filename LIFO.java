...
public class LIFO extends Lab4 {
	//we want to use extends because we need all the input
	
	//we use a stack to implement the LIFO replacement algorithm
	//since stacks are the fundamental data structures of a last in first out method
	Stack <Frame> loadedframes = new Stack <Frame> ();
...
//							cp.loadtime = time;
						...
						//-------------NO FREE FRAMES --> USE REPLACEMENT ALGORITHM	
							...
							currentf = lifo(framet);
							System.out.println("Fault, using lifo");
						...
						//We add the current frame being loaded onto the stack
						//for the implementation of Last In First Out replacement algorithm
						loadedframes.add(currentf);
	...
	public Frame lifo(ArrayList <Frame> framet) {
		//this is the replacement algorithm Last in first out
		//we want to evict the frame that was most recently added 
		return loadedframes.pop();
	}
